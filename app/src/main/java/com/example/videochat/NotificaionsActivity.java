...
public class NotificaionsActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        super.onStart();
        //checking how much request has been sent
        ...
        FirebaseRecyclerAdapter<Contacts, NotificationsViewHolder> firebaseRecyclerAdapter
            ...
            protected void onBindViewHolder(@NonNull final NotificationsViewHolder holder, int i, @NonNull Contacts contacts) {
                ...
                //checking whether request type is sent or received
                DatabaseReference requestTypeRef = getRef(i).child("request_type").getRef();
                requestTypeRef.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if(dataSnapshot.exists()){
                            //it will give the value type weather it is sent or received
                            ...
                            if(type.equals("received")){
                                                                                                        ...
                                                                                                        if(task.isSuccessful()){
                                                                                                            friendRequestRef.child(listUserId).child(currentUserId).removeValue()
                                                                                                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                                        ...
                                                                                                                        public void onComplete(@NonNull Task<Void> task) {
                                                                                                                            if(task.isSuccessful()){
                                                                                                                                Toast.makeText(NotificaionsActivity.this, "New Contact Saved.", Toast.LENGTH_SHORT).show();
                                                                                                                            }
                                                                                                                        }
                                                                                                                    });
                                                                                                        }
                                                                ...
                                                                if(task.isSuccessful()){
                                                                    friendRequestRef.child(currentUserId).child(listUserId).removeValue()
                                                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                ...
                                                                                public void onComplete(@NonNull Task<Void> task) {
                                                                                    if(task.isSuccessful()){
                                                                                        Toast.makeText(NotificaionsActivity.this, "Friend Request Cancelled.", Toast.LENGTH_SHORT).show();
                                                                                    }
                                                                                }
                                                                            });
                                                                }
                                ...
                                //setting visibility to gone if user doesn't receive request
